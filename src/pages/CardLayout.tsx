...
const CardHome = ({ onEnterPressed }: { onEnterPressed: () => void }) => {
  return (
    <div className="relative flex flex-col items-center justify-center rounded-3xl lg:rounded-[3rem] pt-24 sm:pt-32 pb-8 sm:pb-12 px-6 sm:px-12 lg:px-16 w-full max-w-md sm:max-w-lg lg:max-w-2xl bg-slate-50 text-cyan-950">
      <div className="absolute top-2 -translate-y-1/2 w-3/5 sm:w-2/3 lg:w-auto">
        <img
      ...
      <h2 className="relative text-xl sm:text-2xl lg:text-3xl font-semibold text-center leading-snug px-2">
      Money Management for <br />Modern Finance Teams
      </h2>

      <p className="mt-4 sm:mt-6 lg:mt-8 text-center text-xs sm:text-sm lg:text-base leading-relaxed px-2 max-w-md">
      ...
      <button
        className="flex items-center rounded-full px-8 py-3 mt-6 sm:mt-8 bg-cyan-900 text-teal-200 hover:bg-cyan-950 transition-colors"
...
export default function CardLayout() {
  return (
    <div className="min-h-screen w-full overflow-hidden relative bg-white">
      ...
      <main className="flex flex-col items-center justify-between py-6 sm:py-8 lg:py-10 px-4 sm:px-6 lg:px-10 min-h-screen gap-8 sm:gap-10">
        ...
        <div className="flex items-center justify-center pb-4">
          <p className="text-center text-[9px] sm:text-[10px] text-slate-400 max-w-2xl lg:max-w-3xl px-4 leading-relaxed">
