// Version 1: Left-aligned layout with background (Original)
      ...
      <main className="relative z-10 min-h-screen flex items-center">
        <div className="w-full max-w-xl px-8 md:px-12 lg:px-40 py-12 lg:max-w-4xl">
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-4 py-3 rounded-lg bg-cyan-900 text-teal-200 font-medium text-base min-w-24 hover:bg-cyan-950 active:bg-cyan-900 focus:outline-none focus:ring-2 focus:ring-slate-800 focus:ring-offset-2 transition-colors"
          >
            Enter
          </a>
        </div>
